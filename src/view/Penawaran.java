...
public class Penawaran extends javax.swing.JFrame {
    ...
    private void aturTable(){
        ...
        try{
            sql = "SELECT * FROM tb_lelang " +
      "INNER JOIN tb_barang ON tb_lelang.id_barang = tb_barang.id_barang " +
      "LEFT JOIN tb_user ON tb_lelang.id_user = tb_user.id " +
      "WHERE tb_lelang.status = 'dibuka'";
            rs = stat.executeQuery(sql);
            while(rs.next()){
                Object[] isi = {rs.getString("nama_barang"),String.valueOf(fm.format(rs.getDate("tgl_lelang"))),rs.getString("harga_awal"), rs.getString("harga_akhir") == null ? "Belum Ada" : rs.getString("harga_akhir"), rs.getString("nama") == null ? "Belum Ada" : rs.getString("nama")};
                model.addRow(isi);
            }
